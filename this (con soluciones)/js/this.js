...
obj2.greet();
// En modo no estricto, `this` será el objeto global (Window o global). Una función dentro de una función pierde el contexto global
...
obj3.greet();
// Salida: 'Charlie'. Con una función flecha se puede heredar el contexto actual dónde nos encontramos
...
sayHello.call(person1, 'Hello'); //El call coge el contexto de persona 1 [nombreFuncion.call(contexxtoACoger, "parámetro de nombreFuncion")]
sayHello.apply(person1, ['Hi']); //El apply la única diferencia es la sintaxis, hay que pasar el parámetro entre corchetes
// Salida:
// Hello, Dana
// Hi, Dana
...
boundFunction();
// Salida: 'I am Emma'. Solo damos contexto
...
john.describe();
// Salida: 'John is 30 years old.'. Estructura de constructor que hemos visto hasta ahora
